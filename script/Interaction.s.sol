...
contract FundSubscription is Script, CodeConstant {
    ...
    function fundSubscription(address vrfCoordinator, address account, address link, uint256 subId) public {
...
contract AddConsumer is Script {
    function addConsumer(uint256 subId, address consumer, address account, address vrfCoordinator) public {
